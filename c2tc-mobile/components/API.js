async function getBusStops() {
  try {
    let response = await fetch("https://h4i-cut-to-the-case-backend.now.sh/busStops");
...
async function getCrimes() {
  try {
    let response = await fetch("https://h4i-cut-to-the-case-backend.now.sh/crimes");
    let responseJson = await response.json();
...
async function getBusinesses() {
  try {
    let response = await fetch("https://h4i-cut-to-the-case-backend.now.sh/businesses");
    let responseJson = await response.json();
