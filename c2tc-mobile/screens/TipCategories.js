    ...
    return (
        <View style={styles.categories}>
            <View style={styles.header}>
                <Appbar.Header >
                    <Appbar.BackAction style={styles.backButton} onPress={() => this.props.navigation.navigate("TipOverview")} style={styles.backButton} />
                    <Appbar.Content titleStyle = {styles.backHeader} title="Tip Overview" onPress={() => this.props.navigation.navigate("TipOverview")} style={styles.backButton}/>
                    { this.state.selectedCategory !== "" && <Appbar.Content title = "Next" titleStyle = {styles.nextHeader} onPress={() => this.props.navigation.navigate('TipForm', { category: this.state.selectedCategory})}/>}
                </Appbar.Header>
            </View>
