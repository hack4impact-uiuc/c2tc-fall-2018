...
export default reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case 'UPDATE_RENDER_DATA':
      return { ...state, renderData: {...state.renderData, [action.payload.field]: action.payload.value}};
    ...
    case 'UPDATE_DETAIL_VIEW':
      return { ...state, markerClicked:action.payload.clicked, markerTitle:action.payload.title, markerDescription: action.payload.desc };
    case'UPDATE_PAGE':
